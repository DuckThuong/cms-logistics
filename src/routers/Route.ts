...
export const ROUTER_NAME = {
  ...
  SERVICE: "service",
  /** Segment con của /dashboard/service (nested route) */
  SERVICE_DETAIL_ID: ":serviceId",
  PRICE: "price",
  PRICE_DETAIL_ID: ":priceId",
  NEWS: "news",
  NEWS_DETAIL_ID: ":newsId",
...
export const ROUTER_PATH = {
  ...
  SERVICE: `${ROUTER}/${ROUTER_NAME.DASHBOARD}/${ROUTER_NAME.SERVICE}`,
  SERVICE_DETAIL: `${ROUTER}/${ROUTER_NAME.DASHBOARD}/${ROUTER_NAME.SERVICE}/${ROUTER_NAME.SERVICE_DETAIL_ID}`,
  PRICE: `${ROUTER}/${ROUTER_NAME.DASHBOARD}/${ROUTER_NAME.PRICE}`,
  PRICE_DETAIL: `${ROUTER}/${ROUTER_NAME.DASHBOARD}/${ROUTER_NAME.PRICE}/${ROUTER_NAME.PRICE_DETAIL_ID}`,
  NEWS: `${ROUTER}/${ROUTER_NAME.DASHBOARD}/${ROUTER_NAME.NEWS}`,
  NEWS_DETAIL: `${ROUTER}/${ROUTER_NAME.DASHBOARD}/${ROUTER_NAME.NEWS}/${ROUTER_NAME.NEWS_DETAIL_ID}`,

  ABOUT_PAGE: `${ROUTER}/${ROUTER_NAME.ABOUT_PAGE}`,
  SERVICE_PUBLIC: `${ROUTER}/${ROUTER_NAME.SERVICE}`,
  ...
  PRICE_PUBLIC: `${ROUTER}/${ROUTER_NAME.PRICE}`,
